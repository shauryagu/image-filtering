...
def find_maxima(scale_space, k_xy, k_s=1):
    """
...
def visualize_scale_space(scale_space, min_sigma, k, file_path):
    """
...
def visualize_maxima(image, maxima, min_sigma, k, file_path):
    """
